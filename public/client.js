...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ChessBoardDOM = void 0;
const observer_1 = __webpack_require__(/*! ./observer */ "./src/client/observer.ts");
const declarations_1 = __webpack_require__(/*! ./declarations */ "./src/client/declarations.ts");
...
class ChessBoardDOM {
    constructor($boardContaienr) {
        this.$squares = [];
        this.boardState = [];
        this.dropSub = new observer_1.Subject();
        this.dragStartSub = new observer_1.Subject();
    ...
    createSquareDiv() {
        ...
        $square.dataset.type = declarations_1.SQUARE;
        return $square;
    }
    createRowDiv() {
    ...
    createBoardDiv() {
        ...
        for (let y = 0; y < LOGICchessBoard_1.BOARD_SIZE; y++) {
            let $row = this.createRowDiv();
            for (let x = 0; x < LOGICchessBoard_1.BOARD_SIZE; x++) {
    ...
    isPiece(el) {
        return el.dataset.type === declarations_1.PIECE;
    }
    elCoords(el) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ChessBoard = exports.EMPTY = exports.BOARD_SIZE = void 0;
const observer_1 = __webpack_require__(/*! ./observer */ "./src/client/observer.ts");
const piece_1 = __webpack_require__(/*! ./piece */ "./src/client/piece.ts");
exports.BOARD_SIZE = 8;
exports.EMPTY = undefined;
const BACKLINE = [piece_1.Rook, piece_1.Knight, piece_1.Bishop, piece_1.Queen, piece_1.King, piece_1.Bishop, piece_1.Knight, piece_1.Rook];
// TODO Should data for the piece's image be stored here, in Piece class or somewhere else?
class ChessBoard {
    constructor() {
        this.isWhiteTurn = true;
        this.actionSub = new observer_1.Subject();
        this.state = Array(8)
            .fill(0)
            .map(() => new Array(8));
    }
    ...
    isMoveValid(p, to) {
        ...
        if (!(piece instanceof piece_1.Piece) || piece.isWhite !== this.isWhiteTurn)
    ...
    getEnPassant(p, to) {
        let piece = this.state[p.y][p.x];
        if (!(piece instanceof piece_1.Pawn) || piece.hasMoved)
            return undefined;
...
const observer_1 = __webpack_require__(/*! ./observer */ "./src/client/observer.ts");
const LOGICchessBoard_1 = __webpack_require__(/*! ./LOGICchessBoard */ "./src/client/LOGICchessBoard.ts");
const DOMchessBoard_1 = __webpack_require__(/*! ./DOMchessBoard */ "./src/client/DOMchessBoard.ts");
const piece_1 = __webpack_require__(/*! ./piece */ "./src/client/piece.ts");
const BACKLINE = [piece_1.Rook, piece_1.Knight, piece_1.Bishop, piece_1.Queen, piece_1.King, piece_1.Bishop, piece_1.Knight, piece_1.Rook];
...
class chessGame {
    constructor($boardContainer) {
        ...
        this.logic = new LOGICchessBoard_1.ChessBoard();
        this.dom = new DOMchessBoard_1.ChessBoardDOM($boardContainer);
        ...
        let dropObserver = new observer_1.Observer((m) => {
            this.turnMovePiece(m);
        });
        let dragStartObserver = new observer_1.Observer((p) => {
            this.highlightValidMoves(p);
        });
        let actionObserver = new observer_1.Observer((a) => {
            if (!a)
                return;
            console.log(a);
            if (a.move)
    ...
    initGame() {
        let pieces = [];
        for (let i = 0; i < LOGICchessBoard_1.BOARD_SIZE; i++) {
            pieces.push(new BACKLINE[i](0, i, false)); // black
            pieces.push(new BACKLINE[i](7, i, true)); // white
            pieces.push(new piece_1.Pawn(1, i, false)); // black pawns
            pieces.push(new piece_1.Pawn(6, i, true)); // white pawns
        }
        for (let p of pieces) {
    ...
    promote(promTo) {
        ...
        switch (promTo) {
            case 'Queen':
                this.spawnPiece(piece_1.Queen, isWhite, this.promoCoord);
                break;
            case 'Bishop':
                this.spawnPiece(piece_1.Bishop, isWhite, this.promoCoord);
                break;
            case 'Rook':
                this.spawnPiece(piece_1.Rook, isWhite, this.promoCoord);
                break;
        }
    }
    wipeBoard() {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.kingMoveOffsets = exports.knightMoveOffsets = exports.isOutOfBounds = exports.rookMoves = exports.bishopMoves = exports.offsetMoves = exports.vertDiagMoves = void 0;
const LOGICchessBoard_1 = __webpack_require__(/*! ./LOGICchessBoard */ "./src/client/LOGICchessBoard.ts");
function vertDiagMoves(loops, boardState) {
    ...
    for (let loop of loops) {
        ...
        for (; loop.compare(y, x);) {
            ...
            if (squareState === LOGICchessBoard_1.EMPTY)
...
exports.vertDiagMoves = vertDiagMoves;
...
exports.offsetMoves = offsetMoves;
    ...
    return [
        {
            ...
            compare: (y, x) => y < LOGICchessBoard_1.BOARD_SIZE && x < LOGICchessBoard_1.BOARD_SIZE,
            modifyY: true,
            modifyX: true,
            yIncrement: true,
            xIncrement: true,
        },
        {
            ...
            xStart: other.x - 1,
            isWhite: other.isWhite,
            compare: (y, x) => y < LOGICchessBoard_1.BOARD_SIZE && x > -1,
            modifyY: true,
            modifyX: true,
            yIncrement: true,
            xIncrement: false,
        ...
        },
        {
            ...
            xStart: other.x + 1,
            isWhite: other.isWhite,
            compare: (y, x) => y > -1 && x < LOGICchessBoard_1.BOARD_SIZE,
            modifyY: true,
            modifyX: true,
            yIncrement: false,
            xIncrement: true,
    ...
    return [
        {
            ...
            xStart: other.x,
            isWhite: other.isWhite,
            compare: (y, _) => y < LOGICchessBoard_1.BOARD_SIZE,
            modifyY: true,
            modifyX: false,
            yIncrement: true,
        },
        ...
        },
        {
            ...
            xStart: other.x + 1,
            isWhite: other.isWhite,
            compare: (y, x) => x < LOGICchessBoard_1.BOARD_SIZE,
            modifyY: false,
            modifyX: true,
            xIncrement: true,
        },
...
function isOutOfBounds({ y, x }) {
    return !(y < LOGICchessBoard_1.BOARD_SIZE && y > -1 && x < LOGICchessBoard_1.BOARD_SIZE && x > -1);
}
exports.isOutOfBounds = isOutOfBounds;
exports.knightMoveOffsets = [
    { y: -2, x: -1 },
    { y: -2, x: 1 },
    { y: 1, x: 2 },
    { y: -1, x: 2 },
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.PIECE = exports.SQUARE = void 0;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Pawn = exports.Queen = exports.King = exports.Knight = exports.Bishop = exports.Rook = exports.Piece = void 0;
const LOGICchessBoard_1 = __webpack_require__(/*! ./LOGICchessBoard */ "./src/client/LOGICchessBoard.ts");
const declarations_1 = __webpack_require__(/*! ./declarations */ "./src/client/declarations.ts");
const chessMoves_1 = __webpack_require__(/*! ./chessMoves */ "./src/client/chessMoves.ts");
const IMG_SIZE = '80px';
class Piece {
    constructor(y, x, isWhite = true, image) {
        ...
        this.domElement.dataset.type = declarations_1.PIECE;
    }
    move({ y, x }) {
        this.y = y;
        this.x = x;
...
class Rook extends Piece {
    ...
    getValidMoves(boardState) {
        let validMoves = [];
        validMoves = chessMoves_1.vertDiagMoves(chessMoves_1.rookMoves(this), boardState);
...
class Bishop extends Piece {
    ...
    getValidMoves(boardState) {
        let validMoves = [];
        validMoves = chessMoves_1.vertDiagMoves(chessMoves_1.bishopMoves(this), boardState);
        this.validMoveCache = validMoves;
        return validMoves.map((x) => {
            return { p: { y: this.y, x: this.x }, to: x };
        });
...
class Knight extends Piece {
    ...
    getValidMoves(boardState) {
        let validMoves = [];
        validMoves = chessMoves_1.offsetMoves(chessMoves_1.knightMoveOffsets, boardState, this);
        return validMoves;
    }
}
...
class King extends Piece {
    ...
    getValidMoves(bStat, enPassant, includeCastl = true) {
        let validMoves = chessMoves_1.offsetMoves(chessMoves_1.kingMoveOffsets, bStat, this);
        if (includeCastl) {
...
class Queen extends Piece {
    ...
    getValidMoves(boardState) {
        let validMoves = [];
        validMoves = validMoves.concat(chessMoves_1.vertDiagMoves(chessMoves_1.bishopMoves(this), boardState));
        validMoves = validMoves.concat(chessMoves_1.vertDiagMoves(chessMoves_1.rookMoves(this), boardState));
        this.validMoveCache = validMoves;
        return validMoves.map((x) => {
            return { p: { y: this.y, x: this.x }, to: x };
        });
...
class Pawn extends Piece {
    ...
    getValidMoves(boardState, enPass) {
        ...
        for (let m of basicMoves) {
            if (chessMoves_1.isOutOfBounds(m) || boardState[m.y][m.x] !== LOGICchessBoard_1.EMPTY)
                break;
            validMoves.push({ p: { y: this.y, x: this.x }, to: m });
        }
        for (let m of beatMoves) {
            if (chessMoves_1.isOutOfBounds(m) || !this.isEnemy(boardState[m.y][m.x]))
                continue;
            validMoves.push({ p: { y: this.y, x: this.x }, to: m });
        }
        // enPassant
